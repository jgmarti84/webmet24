...
def get_data_station(request):
    r = requests.get('http://clima.omixom.com/xml/xmlUltimaMuestra.php?user=xmllabhidra&pass=xmllabhidra2017&numero=30137')
    xmlret = xml2obj(r.content)
    context = {}
    context['estacion'] = xmlret.estacion
